...
vista modelo = div[style "background" "HSL(167, 80%, 15%)"]
    [div[
        style "display" "flex", style "justify-content" "left", style "align-items" "left"
        ]
    [button [onClick (Fract Snowflake), style "height" "70px" , style"width" "100px",style "background" "HSL(198, 99%, 31%)",style "color" "HSL(198, 0%, 0%)"] [text "SNOWFLAKE"],
     button [onClick (Fract Sierpinsky), style "height" "70px" , style"width" "100px",style "background" "HSL(198, 99%, 31%)",style "color" "HSL(198, 0%, 0%)"] [text "SIERPINSKI"]],
    
    div[style "display" "flex", style "justify-content" "left", style "align-items" "left"]
    [button [onClick (Repte 0), style "height" "70px" , style"width" "100px",style "background" "HSL(198, 99%, 31%)",style "color" "HSL(198, 0%, 0%)"] [Html.text "Disminuir"],
     button [onClick (Repte (1)), style "height" "70px" , style"width" "100px",style "background" "HSL(198, 99%, 31%)",style "color" "HSL(198, 0%, 0%)"] [Html.text "Aumentar"]],
    ...
    in
        Canvas.element
            ...
            (
                ...
                |> Canvas.lineWidth 3
                |> Canvas.fillStyle (Color.hsla 10 7 25 0.9)
